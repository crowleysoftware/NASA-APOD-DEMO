...
namespace WeatherFunction
{
    public class NasaFunctions
    {
        ...
        public NasaFunctions(ILogger<NasaFunctions> logger, IHttpClientFactory httpClientFactory, IHostEnvironment environment)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post")] HttpRequest req)
        {
            ...
            var apodResponse = JsonSerializer.Deserialize<Apod>(content);

            return new OkObjectResult(apodResponse);
        }
    }
